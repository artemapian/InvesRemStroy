...
const MainPage = React.memo(() => {
    return (
        <div className="main-page relative mt-[50px] transition-height duration-300 ease-in-out xl:pb-10 2xl:pb-0 md:mt-0 h-[100lvh] overflow-hidden flex items-center px-5 py-1 md:px-20">
