...
const MainPage = React.memo(() => {
    return (
        <div className="relative h-[100dvh] max-h-[100%] overflow-hidden flex items-center px-5 py-1 md:px-20">
        <div id='main' className="absolute -top-[250px] " aria-hidden="true"></div>
        <div className="absolute inset-0 z-0 ">
            <div
            className="w-auto h-[100dvh] max-h-100% bg-scroll lg:bg-fixed bg-cover bg-center bg-no-repeat"
            style={{
